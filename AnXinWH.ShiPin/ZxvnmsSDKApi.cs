...
namespace AnXinWH.ShiPin
{
    public class ZxvnmsSDKApi
    {
        ...
        [DllImport("ZxvnmsSDK.dll")]
        public static extern int ZXVNMS_PlayVideo(ref string cameraID, int hWnd);
        ...
        public delegate void fStreamCallback(int handle, IntPtr data, int size, IntPtr pUser);
