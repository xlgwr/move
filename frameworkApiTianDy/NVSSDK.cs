...
namespace frameworkApiTianDy
{
    public class NVSSDK
    {
        ...
        [DllImport("DeviceDll/DOME_PLUS.dll", EntryPoint = "GetControlCode", SetLastError = true)]
        private static extern Int32 GetControlCode_DOME_PRIVATE(Int32 _iAction, ref CONTROL_PARAM _cParam);
        ...
        public static Int32 NetClient_GetControlCode(string strDevType, Int32 _iAction, ref CONTROL_PARAM _cParam)
        {
            ...
            if (strDevType == "DOME_PLUS")
            {
                return GetControlCode_DOME_PRIVATE(_iAction, ref _cParam);
            }
